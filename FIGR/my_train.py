...
import numpy as np
import os
from environnements import MnistMetaEnv
...
class FIGR:
    def __init__(self, args):
        ...
        self.env = eval('MnistMetaEnv(height=self.height, length=self.length)')
        self.initialize_gan()
    ...
    def validation_run(self, epoch_number):
        ...
        print("storing image at epoch", str(epoch_number))
        scipy.misc.imsave('test/' + str(epoch_number) + '.png', img)
